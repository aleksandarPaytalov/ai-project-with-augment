/**
 * Sorting utility functions for organizing tool data on the dashboard.
 * Provides functions to sort tools by date, alphabetically, or other criteria.
...
/**
 * Sorts tools alphabetically by name (A-Z)
 *
 * @param tools - Array of tools to sort
